...
const WORKSHOP_SECTIONS: WorkshopSection[] = [
    {
        id: '5.1-Workshop-overview',
        folderName: '5.1-Workshop-overview',
        en: '5.1 Overview',
        vi: '5.1 Tổng Quan',
    },
    {
        id: '5.2-Prerequiste',
        folderName: '5.2-Prerequiste',
        en: '5.2 Prerequisites',
        vi: '5.2 Điều Kiện Tiên Quyết',
    },
    {
        id: '5.3-Foundation-Setup',
        folderName: '5.3-Foundation-Setup',
        en: '5.3 Foundation Setup',
        vi: '5.3 Thiết Lập Nền Tảng',
    },
    {
        id: '5.4-Monitoring-Setup',
        folderName: '5.4-Monitoring-Setup',
        en: '5.4 Data Layer',
        vi: '5.4 Tầng Dữ Liệu',
    },
    {
        id: '5.5-Processing-Setup',
        folderName: '5.5-Processing-Setup',
        en: '5.5 Lambda & AI',
        vi: '5.5 Lambda & AI',
    },
    {
        id: '5.6-Automation-Setup',
        folderName: '5.6-Automation-Setup',
        en: '5.6 API & Social',
        vi: '5.6 API & Xã Hội',
    },
    {
        id: '5.7-Dashboard-Setup',
        folderName: '5.7-Dashboard-Setup',
        en: '5.7 Frontend',
        vi: '5.7 Frontend',
    },
    {
        id: '5.8-Verify-Setup',
        folderName: '5.8-Verify-Setup',
        en: '5.8 ECS Deployment',
        vi: '5.8 Triển Khai ECS',
    },
    {
        id: '5.9-Use-CDK',
        folderName: '5.9-Use-CDK',
        en: '5.9 CI/CD',
        vi: '5.9 CI/CD',
    },
    {
        id: '5.10-Cleanup',
        folderName: '5.10-Cleanup',
        en: '5.10 Cleanup',
        vi: '5.10 Dọn Dẹp',
    },
    {
        id: '5.11-Appendices',
        folderName: '5.11-Appendices',
        en: '5.11 Appendices',
        vi: '5.11 Phụ Lục',
    },
];
